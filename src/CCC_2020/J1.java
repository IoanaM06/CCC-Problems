...
public class J1 {
    int small, medium, large, numEmotion;
    public J1() throws FileNotFoundException {
        var file = new File("Data/CCC_2020/J1");
    ...
    public String happyOrSad() {
        numEmotion = small + (2 * medium) + (3 * large);

        if (numEmotion >= 10) return "happy";
        return "sad";
    }
}
