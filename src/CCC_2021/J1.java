...
you go below sea level, atmospheric pressure increases, and water boils at higher temperatures.
...
begins to boil measured in ◦C.Given the temperature at which water begins to boil, determine
atmospheric pressure. Also determine if you are below sea level, at sea level, or above sea level.
 ...
 */
public class J1 {
    int waterTemp, atmosphericTemp;
    public J1() throws FileNotFoundException {
        var file = new File("Data/CCC_2021/J1");
    ...
    public void calcOutputs() {
        atmosphericTemp = 5 * waterTemp - 400;
        System.out.println(atmosphericTemp);

        if (atmosphericTemp < 100) System.out.println(1);
        else if (atmosphericTemp > 100) System.out.println(-1);
